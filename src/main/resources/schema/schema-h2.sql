...
DROP TABLE IF EXISTS rental_room_pricing_special;
DROP TABLE IF EXISTS rental_room_pricing_weekend_holiday;
DROP TABLE IF EXISTS rental_room_pricing_base;
DROP TABLE IF EXISTS rental_room_unavailable_slot;
DROP TABLE IF EXISTS rental_place_closed_rule;
