...
@RestController
@RequestMapping("/admin/rental/calendar")
@RequiredArgsConstructor
public class RentalCalendarAdminController {

    private final RentalCalendarService rentalCalendarService;

    @GetMapping
    public ApiResponse<List<RentalCalendarDayResponse>> getCalendar(RentalCalendarRequest request) {
